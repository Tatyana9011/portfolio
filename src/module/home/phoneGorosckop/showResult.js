...
<br/><div class="empti"></div>
    <div class= "resultFooter"> 
        ...
        <div class="footer heart">
             <img src="${require(`../../../assets/images/HardBlackColor.png`)}" alt=""/>
